...
export const TRANSLATIONS = {
  en: {
    ...
    forecast: "Forecast // TimesFM", forecastSub: "7-day outlook · p10–p90 band",
    forecastBaseline: "BASELINE", forecastStale: "STALE",
    forecastIdle: "Forecast engine idle — run scripts/forecast/forecast_runner.py to populate the 7-day outlook.",
  ...
  ms: {
    ...
    forecast: "Ramalan // TimesFM", forecastSub: "Pandangan 7-hari · jalur p10–p90",
    forecastBaseline: "ASAS", forecastStale: "LAPUK",
    forecastIdle: "Enjin ramalan terbiar — jalankan scripts/forecast/forecast_runner.py untuk hasilkan pandangan 7-hari.",
  ...
  zh: {
    ...
    forecast: "预报 // TimesFM", forecastSub: "7日展望 · p10–p90 区间",
    forecastBaseline: "基线", forecastStale: "过时",
    forecastIdle: "预报引擎空闲 — 运行 scripts/forecast/forecast_runner.py 生成 7 日展望。",
