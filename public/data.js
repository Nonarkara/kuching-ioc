...
export const TRANSLATIONS = {
  en: {
    ...
    intelRail: "Headlines", atomicSync: "Atomic Sync", aseanDesks: "ASEAN Desks",
    radar: "Map // Greater Kuching", telemetry: "Telemetry", envSignals: "Environment",
    intelligence: "Intelligence", searchPulse: "Search Pulse", tactical: "Tactical",
    directives: "What to do", orbitalView: "Orbital View", satelliteOptic: "Satellite Optic",
    groundTruth: "Ground Truth", sourceStack: "Where this data comes from", assetMap: "Asset Map",
    jurisdictions: "Jurisdictions", allSectors: "All Sectors", padawan: "Padawan",
    commandExport: "SHARE BRIEF", sysOperational: "BOARD READY",
    exchange: "Exchange // MYR", cityPulse: "City Pulse", demographics: "Demographics",
    airport: "Airport // KCH", flightTracker: "Flights near KCH",
    ...
    forecast: "Next 14 days", forecastSub: "Best guess with a high–low range",
    forecastBaseline: "BASELINE", forecastStale: "STALE",
    forecastIdle: "14-day outlook not loaded yet — open the live board after the next data refresh.",
    forecastSeries_river_discharge: "River flow",
    forecastSeries_rainfall: "Rainfall",
    forecastSeries_aqi: "Air quality",
    forecastSeries_pm25: "PM2.5",
    floodMatrix: "Flood outlook by station",
    floodAction: "Flood watch // Padawan basin",
    hydroGauges: "River gauges // what they mean",
    citizenReports: "Citizen reports",
    briefNow: "Do this today",
    briefNext: "Watch next 6 hours",
    briefBlind: "Gaps in the picture",
    riverDischarge: "River flow forecast",
    zone1: "Do I need to act?", zone1Sub: "Verdict · today's numbers · directives",
    zone2: "What's coming?", zone2Sub: "14-day outlook · rain-to-river cascade",
  ...
  ms: {
    ...
    intelRail: "Tajuk berita", atomicSync: "Sinkronisasi", aseanDesks: "Meja ASEAN",
    radar: "Peta // Greater Kuching", telemetry: "Telemetri", envSignals: "Alam sekitar",
    intelligence: "Perisikan", searchPulse: "Denyut Carian", tactical: "Taktikal",
    directives: "Apa perlu dibuat", orbitalView: "Pandangan Orbital", satelliteOptic: "Optik Satelit",
    ...
    commandExport: "KONGSI RINGKASAN", sysOperational: "PAPAN SEDIA",
    exchange: "Tukaran // MYR", cityPulse: "Denyut Bandar", demographics: "Demografi",
    airport: "Lapangan Terbang // KCH", flightTracker: "Penerbangan berhampiran KCH",
    ...
    forecast: "14 hari akan datang", forecastSub: "Anggaran dengan julat tinggi–rendah",
    forecastBaseline: "ASAS", forecastStale: "LAPUK",
    forecastIdle: "Ramalan 14 hari belum dimuat — buka semula selepas kemas kini data.",
    forecastSeries_river_discharge: "Aliran sungai",
    forecastSeries_rainfall: "Hujan",
    forecastSeries_aqi: "Kualiti udara",
    forecastSeries_pm25: "PM2.5",
    floodMatrix: "Prospek banjir mengikut stesen",
    floodAction: "Kawalan banjir // Lembangan Padawan",
    hydroGauges: "Stesen sungai // maksudnya",
    citizenReports: "Laporan awam",
    briefNow: "Buat hari ini",
    briefNext: "Perhatikan 6 jam akan datang",
    briefBlind: "Kekurangan maklumat",
    riverDischarge: "Ramalan aliran sungai",
    zone1: "Perlu bertindak sekarang?", zone1Sub: "Keputusan · angka hari ini · arahan",
    zone2: "Apa yang akan datang?", zone2Sub: "Tinjauan 14 hari · lata hujan-ke-sungai",
    zone3: "Di mana, siapa terdedah?", zone3Sub: "Peta langsung · tolok · wad · ahli majlis",
    zone4: "Apa kata orang ramai?", zone4Sub: "Akhbar 3 bahasa · denyut lapangan · ekonomi",
    zone5: "Adakah bandar mendahului longkangnya?", zone5Sub: "Pertumbuhan satelit 2017–2024 · permukaan kedap · 525 lokaliti",
    ...
    kchAirspace: "Penerbangan berhampiran KCH",
  ...
  zh: {
    ...
    intelRail: "新闻头条", atomicSync: "原子同步", aseanDesks: "东盟时区",
    radar: "地图 // 大古晋", telemetry: "遥测", envSignals: "环境",
    intelligence: "情报", searchPulse: "搜索脉搏", tactical: "战术",
    directives: "该做什么", orbitalView: "轨道视图", satelliteOptic: "卫星光学",
    groundTruth: "地面实况", sourceStack: "数据来源", assetMap: "资产地图",
    jurisdictions: "管辖区", allSectors: "全部区域", padawan: "巴达旺",
    commandExport: "分享简报", sysOperational: "看板就绪",
    exchange: "汇率 // MYR", cityPulse: "城市脉搏", demographics: "人口统计",
    airport: "机场 // KCH", flightTracker: "古晋机场附近航班",
    ...
    briefNext: "未来6小时留意",
    briefBlind: "信息缺口",
    riverDischarge: "河流流量预报",
    zone1: "需要立即行动吗？", zone1Sub: "判定 · 今日数据 · 指令",
    zone2: "接下来会怎样？", zone2Sub: "14天展望 · 雨水入河时序",
    zone3: "在哪里？谁受影响？", zone3Sub: "实时地图 · 水位站 · 选区 · 议员",
    zone4: "民众在说什么？", zone4Sub: "三语媒体 · 舆情脉搏 · 经济",
    zone5: "城市扩张是否超过排水能力？", zone5Sub: "卫星增长 2017–2024 · 不透水面 · 525 个地方",
    wardRisk: "选区暴露 // 水位 × 物业",
